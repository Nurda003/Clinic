  ...
  return (
    <div className='flex items-center justify-around p-5'>
        <div className="flex flex-col">
            ...
            <div className="mb-10">
                <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 rounded-lg px-7'>Book an appointment</button>
            </div>
            <div className="w-96">
        ...
        <div className="">
            <img src={heroimg} className="w-heroimg h-heroimg bg-gradient-to-t from-white to-white" alt="" />
